...
```bash
go get github.com/nothub/goph
```

You can find the docs at [go docs](https://pkg.go.dev/github.com/nothub/goph).
...
See [Examples](https://github.com/nothub/goph/blob/trunk/examples).
...
Goph is provided under the [MIT License](https://github.com/nothub/goph/blob/trunk/LICENSE).
